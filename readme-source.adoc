...
- https://github.com/vercel/pkg[pkg] to bundle the application as a single executable
- {esbuild}[esbuild] to work around current pkg's https://github.com/vercel/pkg/issues/1291[lack of support] for http://nodejs.org/dist/latest-v16.x/docs/api/esm.html[ESM]
